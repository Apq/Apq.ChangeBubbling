...
## PathBasedEventFilter\.ShouldBubble\(BubblingChange, string\) Method
...
<a name='Apq.ChangeBubbling.Infrastructure.EventFiltering.PathBasedEventFilter.ShouldBubble(Apq.ChangeBubbling.Abstractions.BubblingChange,string).change'></a>

`change` [BubblingChange](Apq.ChangeBubbling.Abstractions.BubblingChange.md 'Apq\.ChangeBubbling\.Abstractions\.BubblingChange')

变更事件

<a name='Apq.ChangeBubbling.Infrastructure.EventFiltering.PathBasedEventFilter.ShouldBubble(Apq.ChangeBubbling.Abstractions.BubblingChange,string).context'></a>
